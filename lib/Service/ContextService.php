...
class ContextService {
	...
	/** @return list<array{id: int, title: string, icon: string, alias: string|null, createdAt: string, updatedAt: string}> */
	public function list(string $uid): array {
		return array_map($this->toResponse(...), $this->ensureDefault($uid));
	}

	/** @return array{id: int, title: string, icon: string, alias: string|null, createdAt: string, updatedAt: string} */
	...
	/** @return array{defaultContextId: int, contexts: list<array{id: int, title: string, icon: string, alias: string|null, createdAt: string, updatedAt: string}>} */
